#Redux React CRUD practice App

1. Redux `store`: entire state of app lives here
2. the `store` is an OBJECT that has methods to:
  -get current state of app
  -subscribe to changes
  -update state
  -if a component needs data: ask `store`
